...
export const COPY: Record<Locale, Copy> = {
  "zh-CN": {
    ...
    uploadDescription:
      "上传一幅能代表此刻心情的作品，AI 将从色彩与情感的角度，为你生成专属解读与陪伴。",
    ...
    privacyBody:
      "我们尊重并保护你的隐私。上传内容仅用于本次解读，不会被保存或用于其他用途。",
    recentReports: "最近的报告",
    viewReport: "查看报告",
    login: "登录",
    loginTitle: "欢迎回来",
    ...
    phoneOptionalHint: "手机号为选填；填写后需完成短信验证。",
    codeSent: "验证码已发送，请查收。",
  ...
  en: {
    ...
    uploadProgressHint:
      "Your artwork is being transferred securely. Keep this page open.",
    analysisProgressHint:
      "Estimated progress while we read the colour, composition, and emotion in your work.",
    processingError:
      "Processing did not finish. Check your connection and try again.",
    ...
    forgotOrSetPassword: "Forgot password",
    ...
    registerAndLogin: "Create account",
    phoneOptionalHint:
      "Phone is optional; if entered, verify it with a text code.",
